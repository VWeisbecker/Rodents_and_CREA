...
#After all this, we now just run a simple compare.pls line to also compare integration strengths - although for the purposes of the paper, we decided that this is going overboard.
...
#again, we could compare integraiton strength but that is overkill
...
```{r}
# Define (admittably brute force) function to run Mantel test on 5 modules named . Takes in a shape dataset and landmark definitions of modules made earlier in the script.

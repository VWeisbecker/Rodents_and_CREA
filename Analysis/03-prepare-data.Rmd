...
for (i in length(empty_module_list)){
...
Mean_module_shapes <- empty_module_list
...
#some check to ensure no error crept in - the r-pls values of the separately gpa'ed modules and the equivalent partition in the whole-shape gpa should be very high
...
mean_modules_shapesize <- empty_module_list
...
#Checks to make sure the csizes all match up with the full data, just a correlation.
...
#for the modules:
module_sizeshape_tree <- empty_module_list
